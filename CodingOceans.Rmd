...
DataBase = read_sf(dsn = "/Users/lucaskeyt/Desktop/mpa_inventory_2014_public_shp", layer = "mpa_inventory_2014_public_shp")
...
POLYGON = list(matrix(cbind(lon, lat), ncol = 2))
...
```{r}
SpeciesOccurence <- occurrence(geometry = "POLYGON ((-119.41 34.0, -119.41 34.0, -119.36 34.08, -119.36 34.006, -119.41 34.0)) ")

SpeciesOccurence <- occurrence(geometry = "POLYGON (("[lonlat]")) ")

lat = c(34.0, 34.0, 34.08, 34.006, 34.0)
lon = c(-119.41, -119.41, -119.36, -119.36, -119.41)
lonlat = rbind(lon, lat)


latlon = rbind(Longitude, Latitude)
SpeciesOccurence <- occurrence(geometry = "POLYGON (("[latlon]")) ")
